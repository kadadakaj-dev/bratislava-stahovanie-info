        ...
        <div className="sticky top-16 bg-surface-1/80 backdrop-blur-md shadow-glass py-3 px-4 sm:px-6 lg:px-8 z-40 -mx-4 sm:-mx-6 lg:-mx-8 mb-8 border-b border-border">
            <div className="container mx-auto flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                     <a href="mailto:info@viandmo.com" onClick={trackEmail} className="inline-flex items-center gap-2 justify-center px-4 py-2 border-2 border-accent text-accent text-sm font-bold rounded-md hover:bg-accent hover:text-surface-1 transition-colors">
